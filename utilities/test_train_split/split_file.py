...
def read_split_write(test_data_file, test_size, random_seed):
    ...
    write_csv(data_train, test_data_file.replace('.csv', '_valid.csv'))
    write_csv(data_test, test_data_file.replace('.csv', '_test.csv'))


def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Split a CSV file into a training and testing dataset.")
...
def main():
    ...
    read_split_write(args.input, args.test_size, args.random_seed)
